...
Tabs.profile:AddParagraph({
        Title = "JOIN DISCORD ZINER HUB",
        Content = "https://discord.com/invite/RPafmv6RD6"
    })
			...
			if _G.AutoObservationHakiV2 then
				...
				elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Fruit Bowl") or game.Players.LocalPlayer.Character:FindFirstChild("Fruit Bowl") then
					...
					for i,v in pairs(game.Workspace:GetDescendants()) do
						if v.Name == "Apple" or v.Name == "ziner" or v.Name == "Pineapple" then
...
Fluent:Notify({
    Title = "ZINER HUB",
    Content = "@"..game.Players.LocalPlayer.Name.."https://discord.com/invite/RPafmv6RD6",
    Duration = 8
})
