...
game:GetService("Players").LocalPlayer.Idled:connect(function()
	print("|Ziner hub| AFK detected, prevented +1")
...
spawn(function()
	print("|Ziner hub| Anti Stranger Join")
	while wait() do
		pcall(function()
			if _25msShared.AntiStranger then
				for L_222_forvar0, L_223_forvar1 in pairs(game:GetService("Players"):GetChildren()) do
					if L_223_forvar1.Data.Level.Value >= 2601 or L_223_forvar1.Data.Level.Value > 20000 then
						game.Players.LocalPlayer:Kick("Ziner hub")
						print("|Ziner hub| Detected Stranger, Hopping Server...")
						Hop()
					end
				end
			end
	...
	task.spawn(function()
		...
		if setfflag then
			task.spawn(function()
				...
				print("|Ziner hub| Anti Ban Loaded in: " .. os.clock() - L_228_)
			end)
		else
			print("|Ziner hub| Anti Ban not support this Executor!")
		end
	end)
end)
L_35_.Setting:Line()
...
task.delay(2, function()
	if hookfunction and not islclosure(hookfunction) then
		print("|Ziner hub| Remove Effects")
...
print("| Ziner hub | loading thành công  " .. os.clock() - L_1_)
Notify("<Color=White> Script đặt dành riêng cho KING OF SEA discord săn Levi siêu vip của kaibeo <Color=/>", 10)
Notify("<Color=Blue>Cảm ơn đã sửa dụng ziner hub<Color=/>", 8)