...
spawn(
    function()
        ...
        wait(.5)
        require(game.ReplicatedStorage.Notification).new("<Color=Red>Ziner-hub on top<Color=/>"):Display()
        wait(.14)
...
M:AddParagraph("redeem code", "auto code x2 XP .")
...
spawn(
    function()
        while wait() do
            SV:Set("Giờ máy chủ : " .. function8() .. " | " .. CheckMoon() .. " | " .. function7())
        end
    end
)
                    ...
                    if _G.AutoEliteHunter then
                        if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                            ...
                            OrionLib:MakeNotification(
                                {
                                    Name = "Ziner-hub",
                                    Content = "[VN] : tao xin đấy đừng báo t nữa ",
                                    Image = "rbxassetid://15867528462",
                                    Time = 9
                                }
                            )
