...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> WELECOM TO Ziner-hub <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Blue>THÔNG BÁO:Hub mới nên ít tính năng <Color=/>"):Display()
end)
...
local Window = Fluent:CreateWindow({
    Title = "Ziner-hub | ".._G.Version,
    SubTitle = "By kai wibu",
    TabWidth = 80,
...
local Tabs = {
    Main = Window:AddTab({ Title = "main tap", Icon = "" }),
    Stats = Window:AddTab({ Title = "stats tap", Icon = "" }),
    Player = Window:AddTab({ Title = "player tap", Icon = "" }),
    Teleport = Window:AddTab({ Title = "teleport tap", Icon = "" }),
    Fruit = Window:AddTab({ Title = "fruit tap", Icon = "" }),
    Raid = Window:AddTab({ Title = " raid tap", Icon = "" }),
    Visual = Window:AddTab({ Title = "Visual tap", Icon = "" }),
    St = Window:AddTab({ Title = "Status Sever tap", Icon = "" }),    
    Race = Window:AddTab({ Title = "Race v4 tap", Icon = "" }),
    Shop = Window:AddTab({ Title = "shop tap", Icon = "" }),
	Misc = Window:AddTab({ Title = "Misc tap", Icon = "" }),
    Setting = Window:AddTab({ Title = "settings tap", Icon = "" }),
}
